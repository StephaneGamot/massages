  ...
  return (
    <html lang="fr">
      <head>
        ...
        <meta
          property="og:title"
          content="La voie du bien-être | Détente et Relaxation"
        />
        <meta
          property="og:description"
          content="Profitez d’un massage unique à Halle. Shiatsu, Reiki, et relaxation profonde vous attendent."
        />
        ...
        <meta
          property="og:image"
          content="https://lavoiedubienetre.be/img/OpenGraph/OG-image-massage-Courcelles.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="La voie du bien-être | Shiatsu Reiki Massage à Halle"
        />
        ...
        <meta
          ...
          content="Image montrant un massage relaxant à Halle dans le centre La voie du bien-être"
        />
        <meta name="twitter:site" content="@voiedubienetre" />
        <meta
          name="twitter:description"
          content="Centre de massage à Halle | Shiatsu Reiki Reflexologie Plantaire | La voie du bien-être"
        />
